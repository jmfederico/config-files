# Generated by Powerlevel10k configuration wizard on 2020-09-18 at 10:32 CEST.
...
# P10K does not have an easy way to Hide PYENV when a VENV is active,
# it has an option to do the oposite, which I do not want.
# Here I hide the PYENV prmpt if a VENV is active.
eval "`declare -f prompt_pyenv | sed '1s/.*/_&/'`" #backup old prompt_pyenv to _prompt_pyenv
prompt_pyenv() {
